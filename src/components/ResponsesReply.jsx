...
// import { getRepliesOfReply } from "../services/commentServices";

// export default function ResponsesReply() {
//   const [responsesReplies, setResponsesReplies] = useState([]);

//   async function fetchRepliesOfResponses() {
//     const reply = await getRepliesOfReply();

//     console.log(reply);
//     setResponsesReplies(reply.data);
//   }

//   useEffect(() => {
//     fetchRepliesOfResponses();
//   }, []);
//   return (
//     <div>
//       {responsesReplies &&
//         responsesReplies.map((reply, index) => (
//           <div key={index}>
