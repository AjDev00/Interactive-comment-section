            ...
            {loading && (
              <div>
                <button
                  disabled
                  type="submit"
                  className="disabled:cursor-not-allowed text-[15px] border border-transparent bg-blue-800 cursor-pointer text-white p-3 font-bold px-5 rounded-md hover:opacity-60 duration-300"
                >
                  Sending...
                </button>
              </div>
